...
def batch_put(food_list):
    ...
    table = DDB.Table('FoodProducts') #The table that will be written to by the script 
    # with table.batch_writer(overwrite_by_pkeys=['product_name']) as batch: #batch_writer() opens the connection to the database. 
